...
public class Spent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actvcompany=findViewById(R.id.actv_company);
        arrayList_company=new ArrayList<>();
        arrayList_company.add("Amazon");
        arrayList_company.add("bigbasket");
        arrayList_company.add("Emirates");
        arrayList_company.add("MedPlus");
        arrayList_company.add("Swiggy");
        ...
        balance=getIntent().getStringExtra("spent");
